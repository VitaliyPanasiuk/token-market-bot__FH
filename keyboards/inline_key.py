...
inline_btn_on_startup = InlineKeyboardButton(
    'Приветсвеный текст', callback_data='on_startup')
inline_btn_instruction = InlineKeyboardButton(
    'инструкции', callback_data='instruction')
inline_btn_contacts = InlineKeyboardButton(
...
inline_kb_change_text.add(inline_btn_on_startup, inline_btn_instruction,
                          inline_btn_contacts, inline_btn_price1, inline_btn_price2, inline_btn_price3)
